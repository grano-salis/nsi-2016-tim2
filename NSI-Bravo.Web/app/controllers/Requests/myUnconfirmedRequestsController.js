...
app.controller('myUnconfirmedRequestsController', ['$scope', '$location', '$timeout', '$routeParams', '$log', 'myCVService', 'requestsService', '$route', function ($scope, $location, $timeout, $routeParams, $log, myCvService, requestsService, $route) {
    // MY CV TABLE
    ...
    function GetUnconfirmedRequests() {
        ...
        requestsService.GetMyUnconfirmedRequests().then(function (response) {

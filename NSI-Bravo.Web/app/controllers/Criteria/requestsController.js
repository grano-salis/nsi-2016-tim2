...
app.controller('requestsController', ['$scope', '$location', '$timeout', '$routeParams', '$log', 'requestsService', '$route', function ($scope, $location, $timeout, $routeParams, $log, criteriaService, $route) {
